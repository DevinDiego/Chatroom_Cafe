...
class Message {
	...
	} // END function getMostRecentUser()
	...
	} // END function sendMessage($user_to, $body, $date)
	...
	public function getMessages($otherUser) {
		...
		return $data;
	} // END function getMessages($otherUser)
	...
	} // END function getLatestMessage($userLoggedIn, $user2)
	...
	public function getConvosDropdown($data, $limit) {
		...
		return $return_string;
	} // END function getConvosDropdown($data, $limit)
